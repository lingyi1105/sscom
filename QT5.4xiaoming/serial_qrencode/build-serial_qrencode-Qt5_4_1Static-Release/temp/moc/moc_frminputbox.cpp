...
#include "../../../serial_qrencode/usercontrol/frminputbox.h"
...
struct qt_meta_stringdata_frmInputBox_t {
    QByteArrayData data[3];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_frmInputBox_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_frmInputBox_t qt_meta_stringdata_frmInputBox = {
    {
QT_MOC_LITERAL(0, 0, 11), // "frmInputBox"
QT_MOC_LITERAL(1, 12, 16), // "on_btnOk_clicked"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "frmInputBox\0on_btnOk_clicked\0"
};
...
const QMetaObject frmInputBox::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_frmInputBox.data,
      qt_meta_data_frmInputBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *frmInputBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_frmInputBox.stringdata))
